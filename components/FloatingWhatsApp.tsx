  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed bottom-6 left-6 w-16 h-16 bg-[#B89564] text-white rounded-none flex items-center justify-center text-2xl shadow-2xl z-[100] hover:scale-110 transition-transform animate-bounce-slow"
      >
